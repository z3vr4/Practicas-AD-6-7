...
- Invocan a los services para saber qué info devolver
#### Services
- Contienen lógica de negocio (filtrar, confirmar, etc) para interactuar con la base de datos
- Interactuan con la base de datos a través de los DAO que contienen (inyectados por Spring)
#### DAO
- Data Access Object creados a partir de las Entities
- Son interfaces que extienden CrudRepository<Entity>, asi que exponen métodos CRUD básicos
...
#### Por convención, las llamamos algo como IDepartamentoEntityDAO
